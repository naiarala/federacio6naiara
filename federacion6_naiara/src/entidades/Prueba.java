...
public class Prueba {
	...
	// Ejercicio 4 de la prueba 6.
	/**
	 * Mediante el get se optiene los datos del resultado
	 */
//	@Override
//	public String toString() {
//		return "Prueba [id=" + id + ". nombre=" + nombre + ", fecha="
//				+ fecha.format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) + ", individual=" + individual + ", lugar="
//				+ lugar + ", arbitraje=" + Arrays.toString(arbitraje) + ", resultado=" + resultado + ", participantes="
//				+ Arrays.toString(participantes) + "]" + ",resultado=" + "resultado.cerrarResultado(resultado.getPrimero, resultado.getSegundo , resultado.getTercero)"
//				+ ",idParticipante=" + participantes.getId() + ", dorsal=" + participantes.getdorsal + ",calle=" + participantes.getcalle;
//	}
